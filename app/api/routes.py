...
from app.api import catalog_images, catalog_products, deals, favorites, health, products, retailers, saved_searches, searches
...
api_router.include_router(catalog_products.router, prefix="/api/catalog-products", tags=["catalog-products"])
